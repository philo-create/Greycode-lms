const fs = require('fs');
let content = fs.readFileSync('src/app/dashboard/parent/student/[id]/page.tsx', 'utf8');
...
if (content.includes(target)) {
  ...
  fs.writeFileSync('src/app/dashboard/parent/student/[id]/page.tsx', content);
  console.log('Parent done');
} else {
  console.log('Target not found in Parent');
}
